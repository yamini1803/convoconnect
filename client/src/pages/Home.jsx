        ...
        <div className="homePage-hero">
          ...
          {!userName || userName === 'null' ? 
            ...
            <div className="home-app-intro">
              ...
              <h2>Limitless <b> Collaboration: </b> Revolutionize Your Meetings with Cutting-Edge <b> Video Conferencing </b></h2>
              <p>Discover a new era of virtual meetings with our cutting-edge video conferencing solution, featuring seamless collaboration and superior quality!!</p>
          ...
          <>
            <div className="home-app-intro">
                ...
                <h2>Limitless Collaboration: Revolutionize Your Meetings with Cutting-Edge Video Conferencing</h2>
            </div>
              ...
              <div class="modal-dialog modal-dialog-centered" style={{width: "30vw"}}>
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    ...
                    <>
                    <p style={{margin: " 10px 0px 0px 0px", color: 'rgb(21, 156, 160)'}}>Meet Date: </p>
